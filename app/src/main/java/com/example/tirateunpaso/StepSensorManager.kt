...
class StepSensorManager(VM : StepCounterVM): AppCompatActivity(), SensorEventListener {
    ...
    private val viewModel : StepCounterVM = VM
    ...
    override fun onSensorChanged(event: SensorEvent?    ) {
        if (event!!.sensor.getType() == Sensor.TYPE_STEP_COUNTER){
            ...
            viewModel.UpdateSteps(todaySteps + sessionSteps)
        }
    }
